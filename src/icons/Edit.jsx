...
const Edit = () => {
    ...
    return (
        ...
        <path d="M14.9102 4.15002C15.2417 5.32749 15.8701 6.40009 16.7351 7.26507C17.6001 8.13005 18.6727 8.75843 19.8502 9.09002" stroke="white" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    )
}
